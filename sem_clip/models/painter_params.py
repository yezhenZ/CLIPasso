...
class PainterOptimizer:
    ...
    def init_optimizers(self):
        ...
        self.gcn_optim = torch.optim.Adam(self.gcn_parameters, lr=0.0001)
        ...
        self.gcn_lr_scheduler = torch.optim.lr_scheduler.StepLR(self.gcn_optim, step_size=2000, gamma=0.1)
